...
Les 90 candidats confirm\'es comme vrais minima au moment de la
r\'edaction (aucune fr\'equence imaginaire -- y compris, le cas \'ech\'eant,
des candidats fragment\'es en plusieurs esp\`eces, chaque fragment \'etant
lui-m\^eme un minimum), deux par ligne. Trois figures, class\'ees par
nombre d'atomes croissant puis par stabilit\'e au sein de chaque
...
(kcal/mol, isom\`ere le plus stable \emph{non-fragment\'e} de sa formule
$=0$), le niveau de th\'eorie de ce $\Delta H$ (DFT ou xTB si le DFT n'est
pas encore termin\'e), sa r\'ef\'erence (num\'ero(s) d'article ou
\emph{our work}), et la mention \emph{fragment\'ee} avec la taille des
morceaux si la structure n'est pas un cluster li\'e unique.
