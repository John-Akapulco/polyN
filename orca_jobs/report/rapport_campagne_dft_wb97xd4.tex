...
r\'edaction (aucune fr\'equence imaginaire), deux par ligne. Trois
figures, class\'ees par nombre d'atomes croissant puis par stabilit\'e au
sein de chaque formule~: Figure~S1 (neutres), Figure~S2 (cations),
Figure~S3 (anions). Chaque structure porte son nom, son groupe ponctuel,
son $\Delta H$ (kcal/mol, isom\`ere le plus stable de sa formule
$=0$), le niveau de th\'eorie de ce $\Delta H$ (DFT ou xTB si le DFT
n'est pas encore termin\'e), sa r\'ef\'erence (num\'ero d'article ou
\emph{our work}), et un indicateur si une distance N--N d\'epasse
1,7~\AA.
