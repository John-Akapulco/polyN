...
GFN2-xTB). La r\'ef\'erence est soit un num\'ero d'article (liste en
Annexe~B), soit \emph{our work} quand la structure ne correspond \`a
aucune entr\'ee de la biblio actuelle -- ce qui inclut, par choix
explicite, les correspondances aux bases externes \texttt{N\_csp} et
\texttt{polyN\_study} (candidats, pas des articles publi\'es) aussi bien
que les topologies r\'eellement in\'edites. Un seul candidat de tout le
jeu correspond effectivement \`a un article publi\'e~: \texttt{N8\_neutral\_neutral\_001}
$=$ \texttt{N8\_C2v\_ring}, r\'ef\'erence~[1].
