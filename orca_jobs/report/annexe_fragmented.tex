...
\vspace{8pt}
\bigskip\noindent\textit{L\'egende g\'en\'erale, Figure~S1~:} sph\`eres bleues reli\'ees par des b\^atonnets = atomes N et liaisons N--N (mod\`ele boules-b\^atonnets, rendu depuis les coordonn\'ees cart\'esiennes .xyz) ; paires group\'ees par candidat, g\'eom\'etrie initiale GFN2-xTB \`a gauche et g\'eom\'etrie finale DFT WB97X-D4 \`a droite pour chacun des 13 candidats fragment\'es dont le calcul DFT est termin\'e (sur les 19 recens\'es au Tableau~S1 ; les autres n'ont pas encore de g\'eom\'etrie DFT \`a montrer).