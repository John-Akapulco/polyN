...
\caption{Confrontation xTB / DFT / CCSD(T)-F12 (cc-pVTZ-F12, single-point sur g\'eom\'etrie DFT resym\'etris\'ee) : rang de stabilit\'e (isom\`ere le plus stable de son groupe (N, charge) = rang~1) aux trois niveaux, et $\Delta E$ CCSD(T)-F12 (kcal/mol) relative \`a ce m\^eme isom\`ere. Limit\'e aux groupes ayant au moins 2 structures avec un calcul CCSD(T) termin\'e -- 40 structures termin\'ees au total au moment de la r\'edaction (campagne en cours, \S\ref{sec:limites}).}
...
\texttt{N5\_cation\_cation\_005} & 5 & 5 & 4 & 112.848 \\
\addlinespace
