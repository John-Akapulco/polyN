...
\input{table_ccsdt_comparison.tex}
...
\input{coverage_summary.tex}

Ces deux constats appellent des r\'eponses diff\'erentes. Les groupes \`a
z\'ero candidat sont, pour la plupart, des charges paires (N$_x^{+}$/N$_x^{-}$,
$x$ pair) jamais \'echantillonn\'ees par le pool~1 sur toute la gamme
N$_4$--N$_{16}$, ainsi que les charges impaires aux tailles $\ge$14
(N$_{14}^{\pm}$, N$_{15}^-$, N$_{16}^{\pm}$) -- une zone o\`u l'\'enum\'eration
combinatoire exhaustive (\texttt{geng}/nauty) devient co\^uteuse
(\`a partir de $n{\sim}14$--16 selon le README de \texttt{polyN\_adapt})
et o\`u le pool~2, con\c{c}u pour peupler une fen\^etre d'\'energie par
mutation locale de l'archive plut\^ot que par \'enum\'eration compl\`ete,
est l'outil naturel pour combler ces cases sans exploser le co\^ut de
calcul. \`A l'inverse, les groupes \`a rendement faible (N$_5^-$, N$_7^+$,
N$_9^+$, N$_{11}^-$, N$_{13}^-$) restent dans la zone confortable du
pool~1 (N$\le$13) mais souffrent d'un fort taux d'attrition apr\`es DFT
(fragmentation, fr\'equence imaginaire, non-convergence) -- signe que les
g\'eom\'etries de d\'epart g\'en\'er\'ees pour ces formules sont
chimiquement peu viables plut\^ot qu'un simple manque de volume~: un
r\'e-\'echantillonnage pool~1 cibl\'e sur ces groupes pr\'ecis (plut\^ot
qu'un changement de g\'en\'erateur) est la piste la plus directe.
...
\input{table_S2_nonconverged.tex}

\bigskip
\input{annexe_nonconverged.tex}
