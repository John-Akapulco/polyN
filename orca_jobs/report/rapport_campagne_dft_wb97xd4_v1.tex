...
converger -- \'energie non fiable, \`a reprendre avec davantage de cycles
(\S\ref{sec:minima}). Un contr\^ole syst\'ematique de connectivit\'e
...
\'energie n'est donc pas exploitable en l'\'etat. Ces 35 sont exclues de
