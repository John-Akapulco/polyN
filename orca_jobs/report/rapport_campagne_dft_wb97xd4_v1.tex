...
est la piste la plus directe. Note d'\'echelle~: le pool~2 \'evalue
chaque candidat en Python, en s\'erie, sur un seul c\oe ur (TBLite/GFN2-xTB
in-process, aucune parall\'elisation par candidat n'est encore
impl\'ement\'ee) -- sans commune mesure avec l'infrastructure
SLURM/MPI des campagnes DFT/CCSD(T) de ce rapport.
